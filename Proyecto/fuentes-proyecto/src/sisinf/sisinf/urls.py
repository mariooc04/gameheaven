...
urlpatterns = [
    ...
    path('home/filter/', views.homeFilter, name = 'homeFilter'),
    ...
    path('searchSteamGames/', views.buscarVideojuegoSteam, name='searchSteamGames'),
    path('addSteamGame/', views.addVideojuegoSteam, name='addSteamGame'),
    ...
    path('reservas/', views.verReservas, name='reservas'),
